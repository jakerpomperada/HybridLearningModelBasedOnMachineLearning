...
class CourseRepository implements ICourseRepository
{
    ...
    {
        DB::table('courses')->insert(['id' => $course->getId(), 'code' => $course->getCode(), 'description' => $course->getDescription(), 'created_at' => now(), 'updated_at' => now(),]);
    }

    public function Update(Course $course): void
    {
        DB::table('courses')->where(['id' => $course->getId()])->update(['code' => $course->getCode(), 'description' => $course->getDescription(), 'updated_at' => now(),]);
    }
