    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Update Academic Term</h3>
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                {!! Form::text('year_from',$term->year_from, ['class' => 'form-control datepicker-year']); !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            {!! Form::label('year_to', 'To Year:', ['class' => 'col-lg-3 col-form-label']); !!}
                            <div class="col-lg-9">
                                {!! Form::text('year_to',$term->year_to, ['class' => 'form-control datepicker-year']); !!}
                            </div>
                        </div>
