...
<div class="content container-fluid">
    ...
    <div class="row">
                            ...
                            <div class="col-xl-6 col-sm-12 d-flex">
                                ...
                                <div class="profile-user-img">
                                    <img class="rounded-circle profile-pic" src="{{$teacher->image_link}}" alt="Profile">
    ...
    margin-left: -31%;"></i>
                                    ...
                                    <input type="hidden" value="{{$teacher->image_name}}" name="image_name" id="image_name" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                {!! Form::text('id_number',$teacher->id_number, ['class' => 'form-control']); !!}
                            </div>
                        </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            {!! Form::text('middlename',$teacher->middlename, ['class' => 'form-control']); !!}
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            {!! Form::date('birthdate',$teacher->birthdate, ['class' => 'form-control']); !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            {!! Form::text('contact_number',$teacher->contact_number, ['class' => 'form-control']); !!}
                        </div>
                    </div>
