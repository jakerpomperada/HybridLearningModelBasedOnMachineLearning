    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col mb-3">
                    <h3 class="page-title"><i class="fas fa-list"></i> &nbsp Record New Student Quizzes</h3>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-4">
                    <h3 class="page-title">Subject: Test</h3>
                </div>
                <div class="col-4">
                    <h3 class="page-title">Year: Test</h3>
                </div>
                <div class="col-4">
                    <h3 class="page-title">Section: Test</h3>
                </div>
            </div>
        </div>
