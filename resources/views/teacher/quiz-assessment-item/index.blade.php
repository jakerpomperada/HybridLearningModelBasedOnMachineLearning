...
@section('content')
    <div class="content container-fluid">
        <div class="page-header">
            ...
            <div class="row align-items-center">
                <div class="col-4">
                    <h3 class="page-title">Date Start: {{$quiz_category->start_date}}</h3>
                </div>
                <div class="col-4">
                    <h3 class="page-title">Title: {{$quiz_category->title}}</h3>
                </div>
                <div class="col-4">
                    <h3 class="page-title">Status: {{$quiz_category->status}}</h3>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-4">
                    <h3 class="page-title">Date End: {{$quiz_category->end_date}}</h3>
                </div>
                <div class="col-4">
                    <h3 class="page-title">Total Questions: {{$quiz_category->total_items}} </h3>
                </div>
            </div>
        </div>
