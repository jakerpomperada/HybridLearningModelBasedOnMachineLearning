...
@endpush
@section('content')
    {!! Form::open(['url' => '/teacher/student-exam-assessment?teaching_load_id=' . $teaching_load_id, 'method' => 'POST']) !!}
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col mb-3">
                    <h3 class="page-title"><i class="fas fa-list"></i> &nbsp New Exam Assessment</h3>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-4">
