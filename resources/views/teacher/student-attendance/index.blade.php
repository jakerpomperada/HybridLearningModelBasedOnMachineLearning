    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title"><i class="fas fa-users"></i>&nbsp;&nbsp Student Attedance</h3>
                                        ...
                                        <form class="needs-validation" method="GET" novalidate="">
                                            <div class="input-group input-group-sm">
                                                <div class="input-group">
                                                    &nbsp; <select disabled  name="academic_year" class="form-control col-lg-2">
                                ...
                                <div class="col-auto text-end">
                                    ...
                                    <button id="cu_subject_term_add_button" class="btn btn-sm btn-success"
                                            data-bs-toggle="modal" data-bs-target="#con-close-modal"><i
                                                class="fas fa-plus"></i> &nbsp;Record Attedance
                                    </button>
                                </div>
                            </div>
                        </div>
