<ul>
    ...
    <li>
        <a href="/admin/dashboard"><i class="feather-grid"></i> <span> Dashboard</span></a>
    </li>
    <li class="menu-title">
    ...
    <li><a href="/admin/report/socio-economic?module=admin"><i class="fas fa-book-open"></i> &nbsp; Socio-economic</a></li>
